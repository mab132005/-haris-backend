...
{{
  ...
  "details": "سبب الخطورة بالتفصيل بالعربية (مثال: تحذير: الرسالة تحوي إغراء بشحنة وهمية وطلب دفع رسوم عبر رابط غير رسمي)"
    ...
    # استثناء الإشعارات الرسمية الموثوقة للرصيد والمعاملات الكاش والبنكية
    is_official_receipt = ("رصيد حسابك" in msg_lower or "رصيد حسابك الحالي" in msg_lower or "تاريخ العمليه" in msg_lower or "تم تحويل مبلغ" in msg_lower or "تم ايداع" in msg_lower) and not ("otp" in msg_lower or "رمز" in msg_lower or "رابط" in msg_lower or "http" in msg_lower or "سلف" in msg_lower or "كلمه سر" in msg_lower)

    if is_official_receipt:
        return {
            "is_fraud": False,
            "confidence_score": 0.98,
            "details": "إشعار رسمي آمن برصيد أو معاملة فودافون كاش"
        }

    is_impersonation_scam = ("سلف" in msg_lower or "مشكل" in msg_lower or "طارئ" in msg_lower or "صديق" in msg_lower or "هحاسب" in msg_lower) or (("محفظ" in msg_lower or "تحول" in msg_lower or "حول" in msg_lower or "كاش" in msg_lower or "فلوس" in msg_lower) and ("سلف" in msg_lower or "حالا" in msg_lower or "جنيه" in msg_lower or "ريال" in msg_lower))
