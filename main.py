        ...
        <div class="table-responsive">
            <table>
                ...
                <tbody id="reportsTableBody">
                    <tr><td colspan="7" style="text-align:center;">جاري تحميل البلاغات...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
    ...
    <script>
        ...
        async function loadReports() {
            try {
                ...
                if (reports.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="7" style="text-align:center;">لا توجد بلاغات مسجلة حالياً.</td></tr>';
                } else {
