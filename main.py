...
<head>
    <meta charset="UTF-8">
    <title>لوحة تحكم حارس 🛡️</title>
</head>
<body style="background-color:#0A0E1A; color:#FFFFFF; font-family:sans-serif; text-align:center; padding:50px;">
    <h1>لوحة تحكم نظام حارس يعمل بنجاح على السحابة 🛡️</h1>
    <p style="color:#00E5FF;">سيرفر FastAPI نشط ومتصل بقواعد البيانات.</p>
</body>
</html>"""
